            ...
            <div className="min-h-screen bg-black px-4 py-20 text-white relative overflow-hidden">
                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="mb-8 flex flex-col gap-4">
                        <div>
                            <h1 className="text-3xl md:text-4xl font-bold mb-2">Problem <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">Library</span></h1>
                            <p className="text-zinc-400 text-sm md:text-base">Browse all {total > 0 ? total.toLocaleString() : '...'} available problems.</p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            ...
                            <select
                                ...
                                className="bg-zinc-900 border border-white/10 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 appearance-none w-full sm:w-auto"
                            ...
                            <div className="relative flex-1 sm:flex-initial">
                                ...
                                <input
                                    ...
                                    className="bg-zinc-900 border border-white/10 rounded-xl pl-10 pr-4 py-2 w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all md:focus:w-80"
                                />
                            </div>
                        </div>
                    </div>
